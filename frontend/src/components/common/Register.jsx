...
const Register = () => {
   ...
   const handleSelect = (eventKey) => {
      ...
      setData({ ...data, role: eventKey.toLowerCase() });
   };
   ...
   const handleSubmit = (e) => {
      e.preventDefault()
      if (!data?.name || !data?.email || !data?.password || !data?.role) return alert("Please fill all fields");
      else {
   ...
   return (
      <>
         <Navbar expand="lg" className="bg-body-tertiary">
            <Container fluid>
               <Navbar.Brand><h2>E-Learning Platform</h2></Navbar.Brand>
